...
Den Einwand, der Skalensprung von der Planck-Geometrie bei $10^{-35}$\,m
bis zur kortikalen Integration bei Zentimetern sei physikalisch unüberbrückbar,
kehrt das Modell um: Biologische Systeme haben genau diesen Übergang als
Funktionsprinzip entwickelt. Fröhlich-Kondensat, Superradianz in Tubulin und
spintronische Kohärenz zeigen, dass makroskopische Quantenzustände thermisches
Rauschen in biologischen Systemen systematisch überwinden — nicht trotz der
Größenverhältnisse, sondern durch die spezifischen Strukturen, die Evolution
bereitgestellt hat. Der Skalensprung ist kein Widerspruch im Modell.
Er ist sein Designprinzip.
...
geordnete, erlebte Sequenz? Die Modelle in Kapitel~\ref{sec:kopplung} und
diesem Kapitel konkurrieren dabei nicht — sie beschreiben denselben Prozess
auf verschiedenen Ebenen der Analyse. David Marr~\citep{marr1982} hat gezeigt,
dass jedes informationsverarbeitende System auf drei voneinander unabhängigen
Ebenen beschrieben werden kann: auf der Ebene dessen, was das System tut und
wozu; auf der Ebene dessen, wie es das tut und welche Darstellung es dabei
verwendet; und auf der Ebene der physischen Realisierung. Eine Erklärung auf
einer Ebene ersetzt die anderen nicht — sie beantwortet eine andere Frage.
...
Orch~OR erklärt nicht, was $K_i$ rechnerisch leistet. Das Free-Energy-Prinzip
erklärt nicht, wie der Kollaps physisch stattfindet. Erst zusammen ergibt
sich ein vollständiges Bild des Interpretationsprozesses.
...
Ein klassischer Einwand gegen Repräsentationstheorien des Bewusstseins
ist der Homunkulus-Einwand: Wenn das Gehirn ein inneres Bild erzeugt,
wer betrachtet dieses Bild dann? Jeder Beobachter würde seinerseits
einen Beobachter erfordern — ein infiniter Regress ohne Auflösung.
Das Interpreter-Modell umgeht diesen Regress durch eine strukturelle
Klarstellung: Das gerenderte Erlebnisbild ist das Bewusstsein — nicht
eine Darstellung, die ein innerer Beobachter wahrnimmt. Der Kollaps von
$K_i$ erzeugt keinen Inhalt, den ein separates Subjekt anschließend
betrachtet. Er ist selbst der Moment, in dem Perspektive entsteht.
Ein Homunkulus ist nicht nötig, weil das Rendering nicht \emph{für}
jemanden stattfindet — es ist das Entstehen von jemandem.
...
Der naheliegendste Einwand gegen die Architektur lautet, sie verstoße
gegen Ockhams Rasiermesser: Planck-Geometrie, Quantenfeld, Orch-OR,
CDT, Bohm und Free-Energy-Prinzip — das sei keine Theorie, sondern
eine Zusammenstellung. Diese Kritik kehrt das Prinzip jedoch um.
Ockhams Rasiermesser fordert nicht eine kleine Zahl von Begriffen,
sondern die kleinste Zahl von Annahmen gemessen an der Zahl der
Phänomene, die strukturiert werden. Ein Modell, das Déjà-vu,
Nahtoderfahrungen, Narkose, nicht-initierten Musterzugriff,
subjektive Zeitbindung und Individualität ohne Sondermechanismen
aus derselben Kopplungsarchitektur ableitet, ist sparsamer als
sechs unabhängige Ad-hoc-Erklärungen für sechs unverbundene
Phänomene. Die Zusammenführung ist nicht die Komplexität des Modells —
sie ist seine Sparsamkeit.
